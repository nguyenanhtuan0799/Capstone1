  ...
  const htmls = `
                    <div class="row">
                     ...
                     <div class="row">
                         <div class="col l-12">
                             <div class="info-body-wrapper">
                                 <label class="info-boy_labels">Headquarters:</label><input type="text" class="form-control" placeholder="country" value="Main Office" disabled />
                             </div>
                         </div>
                     </div>
                     <div class="row">
                         <div class="col l-6">
                             <div onclick="handleEdit(${idProfile})" class="info-button_wrapper" style="margin-top:300px">
                         ...
                         <div class="col l-6">
                             <div class="info-button_wrapper" style="margin-top:300px">
                                 <button class="btn btn-danger profile-button" type="button">
                                     <a href="../../views/manager/managerProfile.php" style="text-decoration: none;
    color: #fff">Cancel</a>
                                 </button>
                             </div>
                         </div>
