...
<div class="row">
        ...
        <div class="col l-6">
            <div class="info-body-wrapper">
                <label class="info-boy_labels">Phone:</label><input type="text" class="form-control" value="${
                  data.phone_number
                }" placeholder="" />
            </div>
        </div>
    ...
    <div class="row">
        <div class="col l-6">
            <div class="info-body-wrapper">
                <label class="info-boy_labels">Fullname:</label><input type="text" class="form-control" placeholder="" value="${
                  data.fullname
                }" />
            </div>
        </div>
        <div class="col l-6">
            <div class="info-body-wrapper">
                <label class="info-boy_labels">Type:</label><input type="text" class="form-control" placeholder="" value="${
                  data.role_id
                }" disabled />
            </div>
        </div>
        <div class="col l-12">
            <div class="info-body-wrapper">
                <label class="info-boy_labels">Email:</label><input type="text" class="form-control" placeholder="" value="${
                  data.email
                }" />
            </div>
        </div>
        <div class="col l-12">
            <div class="info-body-wrapper">
                <label class="info-boy_labels">Address:</label><input type="text" class="form-control" placeholder="" value="${
                  data.address
                }" />
            </div>
        </div>
    ...
    <div class="row">
        <div class="col l-12">
            <div class="info-body-wrapper">
                <label class="info-boy_labels">Headquarters:</label><input type="text" class="form-control" placeholder="" value="${
                  data.headquerter
                }" disabled />
            </div>
        </div>
    ...
    <div class="row">
        <div class="col l-12">
            <div class="info-button_wrapper">
                <button class="btn btn-primary profile-button" style="" type="button">
                    <a href="../../views/employee/employeeEditprofile.php">Edit</a>
                </button>
            </div>
        </div>
    </div>
